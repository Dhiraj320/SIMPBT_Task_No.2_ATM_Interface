...
public class User_data {
    ...
    public User_data(String firstName, String lastName, String pin, Bank_data theBank) {
        ...
        this.accounts = new ArrayList<Account_data>();
    ...
    public void addAccount(Account_data newAccount) {
